...
This test release covers paired-end, paired-guide decoding without UMI/iBAR processing. It includes the duplicate-TSV-header validation fix. It is not a full real-data or production validation of the pipeline.
...
| Screening routing | 2 nf-tests pass                                                                                                      | Stub wiring and version snapshots for CRISPRDecode and default MAGeCK routes |
